import { ChangeDetectionStrategy, Component, computed, ElementRef, HostListener, inject, input, output, signal, viewChild, ViewEncapsulation } from '@angular/core';
...
export class ZardCalendarGridComponent {
  ...
  readonly weekdays = this.dateService.weekdays();
