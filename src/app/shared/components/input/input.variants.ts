...
export const inputVariants = cva('w-full', {
  variants: {
    zType: {
      ...
      textarea:
        'flex min-h-[80px] rounded-md border border-input bg-transparent px-3 py-2 text-base placeholder:text-muted-foreground outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
    },
    zSize: {
