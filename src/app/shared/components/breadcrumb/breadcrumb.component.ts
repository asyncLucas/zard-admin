  ...
  hostDirectives: [
    {
      ...
      inputs: [
        'routerLink: zLink',
        'queryParams: zQueryParams',
        'fragment: zFragment',
        'queryParamsHandling: zQueryParamsHandling',
        'state: zState',
        'relativeTo: zRelativeTo',
        'preserveFragment: zPreserveFragment',
        'skipLocationChange: zSkipLocationChange',
        'replaceUrl: zReplaceUrl',
      ],
    },
  ],
  template: `
