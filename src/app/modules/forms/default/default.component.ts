...
@Component({
  ...
  imports: [ReactiveFormsModule, ZardButtonComponent, ZardInputDirective, ZardFormModule, ZardDatePickerComponent],
  standalone: true,
  template: `
...
export class DefaultFormReactiveComponent {
  ...
  onSubmit() {
    if (this.profileForm.valid) {
      ...
      alert(`Form submitted successfully! ${JSON.stringify(this.profileForm.value, null, 2)}`);
    }
  }
}
